...
export const t = {
  ...
  dayPeriodCancel: 'Hapus catatan ini',
  dayPeriodCancelAsk: 'Hapus catatan haid tanggal ini? Tindakan ini tidak bisa dibatalkan.',
  dayPeriodCancelYes: 'Ya, hapus',
  dayPeriodCancelBack: 'Kembali',
  dayUntil: 'sampai',
  ...
  predOffsetLabel: 'Selisih dari perkiraan',
  predOutsideLabel: 'Perkiraan haid berikutnya',
  predSpreadLabel: 'Sebaran siklus',
  predMore: 'Selengkapnya',
  // Android back button
  exitTitle: 'Tutup Red?',
  exitBody: 'Data Anda sudah tersimpan.',
  exitYes: 'Tutup aplikasi',
  exitNo: 'Batal',
